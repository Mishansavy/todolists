...
#for production
ALLOWED_HOSTS = ['todoapp-backend-sad2.onrender.com', 'localhost','127.0.0.1', 'remo.mishanshah.com.np/']

CORS_ALLOWED_ORIGINS = ['https://todoapp-backend-sad2.onrender.com', 'http://localhost:5173', 'http://remo.mishanshah.com.np/']
